...
def filter_emp(request):
    if request.method == "POST":
        ...
        if name: 
            emps=emps.filter(Q(first_name__icontains = name) | Q(last_name__icontains = name) ) #here Q is define to pick either first or last name #pass anything it will pick
        if dept:
